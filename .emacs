...
(load-file "~/.emacs.d/elisp/simple-tab.el")
...
(load-file "~/.emacs.d/elisp/alpha-window.el")
...
(add-to-list 'exec-path "~/.emacs.d/elisp/w3m")
...
(add-to-list 'load-path "~/.emacs.d/elisp/ac-dict")
